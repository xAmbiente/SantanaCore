...
namespace Santana.Game.GameRules
{
    ...
    internal class ArenaGameRule : GameRuleBase
    {
        ...
        private void EnterCountdown()
        {
            ...
            {
                Trace("BROADCAST Arena_LeaderShowdwon(3103) (leader showdown banner — resets big number)");
                Room.Broadcast(new ArenaLeaderShowdwonMessage());
                Trace("BROADCAST GameBriefingInfoAck(isResult=false) (re-draw the score after the 3103 reset)");
