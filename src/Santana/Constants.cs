...
namespace Santana
{
    ...
    enum RandomShopPriceType
    {
        [field: Description("pen")]
        PEN,
        [field: Description("coupon")]
        CP
    }
    ...
    public enum RandomShopCatgorie : uint
    {
        Weapon = 1001001
    }
    public enum RandomShopBoxColor : byte
    {
        Gray = 0,
        Blue = 20,
        Orange = 50
    ...
    public enum EsperEnchantResult
    {
        Success,
        LevelUnchanged,
        LevelDecreased,
    ...
    public enum MissionRewards : byte
    {
        Weapon,
        Set,
        Pet,
